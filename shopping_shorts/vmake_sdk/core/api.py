...
from ..core.config import USER_AGENT, GID_CACHE_FILE, INVOKE, REGIONS
from ..core.models import TaskResult, TaskStatus
from ..utils.cache import GidCache
from ..auth.signer import Signer, HeaderHost
...
class AiApi:
    ...
    def getFileUrl(self, file):
        ...
        """
        from ..storage.oss import OssUploader, resolve_oss_region, normalize_oss_endpoint
