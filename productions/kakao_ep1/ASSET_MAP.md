...
│
├── 01_veo/                         🟦 Veo AI여자 클립 (네가 Veo에서 생성)
│   ├── intro_1.mp4                 [ ] "방금 이 카톡, 제가 보낸 거 아니에요..."     ~42음절
│   ├── intro_2.mp4                 [ ] "요즘 주식 좀 한다는 분들, GPT 잘 안 써요..." ~41음절
│   ├── intro_3.mp4                 [ ] "딱 10분만 투자하면 내일 아침부터..."         ~37음절
│   ├── intro_4.mp4                 [ ] "방금까지 설명한 저, 사실 클로드가 만든 AI예요..." ~43음절 ← AI리빌
│   ├── outro_a.mp4                 [ ] "방금 보신 이 카톡 브리핑..."                 ~32음절
│   ├── outro_b.mp4                 [ ] "한 번 만들어두면 내일도 모레도..."            ~42음절
│   ├── outro_c.mp4                 [ ] "진짜 핵심은 다음 편이에요..."                ~42음절
│   └── outro_d.mp4                 [ ] "근데 그건 오늘 이 기본편을 세팅해둬야..."    ~39음절
│
