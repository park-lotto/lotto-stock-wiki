...
- [ ] **Step 1: 최신 main을 얹고 row 인덱스를 직접 센다**
...
- [ ] **Step 6: `update_mix_job` 화이트리스트에 쓰기를 추가한다**
...
- [ ] **Step 4: `mix/settings`에 `seo`를 추가한다**
...
- [ ] **Step 4: `/api/produce/mix/state`가 `seo`를 주는지 확인한다**
...
- [ ] **Step 7: 앵커가 살아있는지 확인한다 — 이게 죽으면 게이트가 죽는다**
