...
- 말투: 구조 분석의 tone을 그대로 따른다. 대본이 반말이면 제목·CTA도 반말로 쓴다(영상은 반말인데 제목만 존댓말이면 같은 영상으로 안 보인다).
  ★단, **설명(description)만은 예외로 항상 존댓말(~해요/~예요체)**이다(2026-08-18 사장님 지시).
  설명은 영상 밖에서 처음 보는 사람에게 말을 거는 글이라 반말이면 무례하게 읽힌다.
  (나쁜 예: "이제 집에서 5분 만에 끝내." → 좋은 예: "이제 집에서 5분 만에 끝낼 수 있어요.")
