...
export const SUBCLEAN_CUT: Cut = {
  tiles: [
    {...C95, crop: {x: 0, y: 0, w: 1080, h: 110}, boxes: [{x: 520, y: 8, w: 110, h: 94}]},
...
export const FLOWS: Record<string, FlowProps> = {
  sq_1: {
    ...
    cuts: [
      {tiles: [{...C88, crop: {x: 0, y: 0, w: 1080, h: 110}, boxes: [{x: 0, y: 8, w: 110, h: 94}]}, {...C89, crop: {x: 0, y: 90, w: 1080, h: 392}, pan: [-160, 0], boxes: [{x: 40, y: 60, w: 1000, h: 240}]}, {...C88, crop: {x: 0, y: 500, w: 1080, h: 365}, pan: [80, 0]}]},
      {tiles: [{...C89, crop: {x: 466, y: 60, w: 1080, h: 422}, pan: [-200, 0], boxes: [{x: 590, y: 60, w: 470, h: 300}]}, {...C90, crop: {x: 0, y: 0, w: 1080, h: 560}, pan: [120, 0], boxes: [{x: 10, y: 10, w: 300, h: 330}]}]},
      {tiles: [{...C90, crop: {x: 300, y: 0, w: 1080, h: 808}, pan: [-140, 0], boxes: [{x: 380, y: 60, w: 300, h: 340}, {x: 700, y: 60, w: 300, h: 340}]}, {...C88, crop: {x: 0, y: 190, w: 1080, h: 240}, pan: [200, 0]}]},
      {tiles: [{...C88, crop: {x: 497, y: 500, w: 1080, h: 365}, pan: [0, 0], boxes: [{x: 20, y: 30, w: 300, h: 320}]}, {...C90, crop: {x: 492, y: 100, w: 1080, h: 708}, pan: [-100, 0]}]},
  ...
  sq_2: {
    ...
    cuts: [
      {tiles: [{...C92, crop: {x: 0, y: 0, w: 1080, h: 110}, boxes: [{x: 120, y: 8, w: 110, h: 94}]}, {...C92, crop: {x: 0, y: 180, w: 1080, h: 551}, pan: [-140, 0], boxes: [{x: 20, y: 40, w: 200, h: 130}, {x: 0, y: 345, w: 1080, h: 80}]}, {...C91, crop: {x: 0, y: 0, w: 1080, h: 140}, pan: [100, 0]}]},
      {tiles: [{...C91, crop: {x: 0, y: 0, w: 1080, h: 897}, pan: [-160, 0], boxes: [{x: 0, y: 20, w: 1080, h: 100}, {x: 560, y: 160, w: 250, h: 260}]}, {...C92, crop: {x: 0, y: 500, w: 1080, h: 150}, pan: [140, 0]}]},
      {tiles: [{...C91, crop: {x: 491, y: 140, w: 1080, h: 757}, pan: [0, -40], boxes: [{x: 220, y: 60, w: 250, h: 260}, {x: 750, y: 60, w: 250, h: 260}]}, {...C92, crop: {x: 400, y: 180, w: 1080, h: 260}, pan: [-120, 0]}]},
      {tiles: [{...C91, crop: {x: 0, y: 300, w: 1080, h: 597}, pan: [160, 0], boxes: [{x: 10, y: 250, w: 240, h: 280}]}, {...C92, crop: {x: 100, y: 500, w: 1080, h: 231}, pan: [-100, 0], boxes: [{x: 0, y: 40, w: 1080, h: 60}]}, {...C91, crop: {x: 300, y: 0, w: 1080, h: 140}}]},
      {tiles: [{...C92, crop: {x: 0, y: 0, w: 1080, h: 110}}, {...C92, crop: {x: 527, y: 180, w: 1080, h: 551}, pan: [-120, 0], boxes: [{x: 0, y: 40, w: 1080, h: 130}]}, {...C91, crop: {x: 200, y: 0, w: 1080, h: 140}, pan: [80, 0]}]},
    ],
  },
  sq_3: {
    dur: 270,
    ...
    cuts: [
      {tiles: [{...C93, crop: {x: 0, y: 80, w: 1080, h: 751}, pan: [-120, 0], boxes: [{x: 20, y: 40, w: 390, h: 640}, {x: 440, y: 40, w: 620, h: 110}]}, {...C94, crop: {x: 0, y: 380, w: 1080, h: 250}, pan: [200, 0]}]},
      {tiles: [{...C93, crop: {x: 497, y: 80, w: 1080, h: 751}, pan: [0, 0], boxes: [{x: 0, y: 40, w: 1000, h: 110}, {x: 0, y: 160, w: 520, h: 220}]}, {...C94, crop: {x: 300, y: 380, w: 1080, h: 250}, pan: [-200, 0]}]},
      {tiles: [{...C94, crop: {x: 0, y: 0, w: 1080, h: 894}, pan: [-140, 0], boxes: [{x: 150, y: 20, w: 900, h: 300}, {x: 150, y: 330, w: 900, h: 110}]}, {...C93, crop: {x: 497, y: 400, w: 1080, h: 130}, pan: [100, 0]}]},
      {tiles: [{...C94, crop: {x: 574, y: 300, w: 1080, h: 594}, pan: [0, -60], boxes: [{x: 0, y: 40, w: 1080, h: 180}]}, {...C93, crop: {x: 0, y: 80, w: 1080, h: 430}, pan: [-160, 0], boxes: [{x: 20, y: 40, w: 390, h: 380}]}]},
      {tiles: [{...C94, crop: {x: 0, y: 380, w: 1080, h: 514}, pan: [220, 0], boxes: [{x: 0, y: 0, w: 1080, h: 250}]}, {...C93, crop: {x: 497, y: 80, w: 1080, h: 510}, pan: [0, 0]}]},
    ],
  },
};
