...
def factsheet_block(facts):
    ...
    return ("\n[사실표 — 이 영상의 사실 전부]\n"
            ...
            "합성하지 마라). **생김새·용도도 표와 다르게 바꾸지 마라**"
            # 실측 3회(2026-08-10): '먹던 숟가락'→'숟가락으로 만든다', '키링처럼 생긴'→
            # '키링처럼 휴대'. 이름 조항의 적용 범위 확장이지 새 규칙이 아니다.
            "(예: '키링처럼 생긴'을 '키링처럼 휴대하기 편한'으로 바꾸지 마라). "
            "말투·화자·구도·표현은 완전히 자유다.\n")
