...
const SUBS = [
  { s: 0,   e: 57,  text: '오프닝에서 봤던 이 메시지.' },
  { s: 88,  e: 141, text: '자는 동안만이 아닙니다.' },
  { s: 145, e: 204, text: '낮에 리포트 나오면 즉시.' },
  { s: 223, e: 251, text: '뉴스 뜨면 즉시.' },
  { s: 274, e: 323, text: '밤에 미국 장 열리면 또 즉시.' },
  { s: 323, e: 364, text: '24시간.' },
  { s: 364, e: 439, text: '내가 뭘 하든 상관없이' },
  { s: 439, e: 474, text: '항상 돌아가고 있습니다.' },
  { s: 500, e: 579, text: '저는 이제 주식 분석을 합니다가 아니라' },
  { s: 579, e: 652, text: '주식 분석 팀을 운영합니다.' },
];
