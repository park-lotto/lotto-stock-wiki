...
- "무엇이 움직였다"만 쓰지 말고 "왜"까지 붙여라 — 뉴스 후보나 사실의 mover_causes(원인추적
  캐스케이드로 실제 귀속된 근거)에 원인이 있으면 반드시 그걸 근거로 짚어라. unattributed_movers는
  "원인 미확인" 종목이니 지어내지 말고 그대로 '원인 불명'이라고 밝혀라 — 원인 불명을 숨기지 마라.
