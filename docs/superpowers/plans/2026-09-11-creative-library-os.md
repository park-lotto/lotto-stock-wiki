...
- 착수 baseline: main `16bc986f8`, 설계 문서만 존재.
- 첫 구현: 읽기 전용 공통 카탈로그·6 legacy 어댑터·CLI 및 기술 실사 도구.
- 실제 로컬 조회: 공용141항목(폰트40/레이아웃29/모션6/음성66), 관리자143항목, DB 미지정140항목.
- 기존 운영 writer와 UI/렌더 연결은 아직 전환하지 않았다. Phase 0/1 전체 완료로 간주하지 않는다.
- 상세 실행법: `creative_library/README.md`; 소스 실사: `docs/research/creative-library/source-of-truth.md`.
