...
- effects  : {효과} — 쓰고 나면 **뭐가 되는가**. 눈에 보이는 변화로.
             ★★이 값만은 **'~는' 관형형**으로 끝내라(명사형 '~함/~됨' 금지).
               대본에서 "와 {효과} 거 있죠"처럼 뒤에 말이 붙기 때문이다.
               좋은 예: 누런 때가 자국 없이 빠지는 / 입주 청소한 것처럼 깨끗해지는
               나쁜 예: 누런 때가 빠짐 / 깨끗해짐   ← "깨끗해짐 거 있죠"가 되어 못 쓴다
               (실측 2026-08-19: 명사형으로 뽑았더니 조립문이 "완전 새 것처럼 닦임 거 있죠"였다)
