...
기본값은 자막제거만 실측 근거가 있고 나머지는 임시값이다.
(자막제거 실측 2026-08-22: VMake Watermark Removal = 50크레딧/콜.
 Plus 플랜은 1,000크레딧/월 + 일 10건까지 Free Usage로 0크레딧 처리된다
 — 즉 하루 10편 이하면 크레딧을 안 쓴다. 개발자 대시보드 Usage Details에서 확인.)
...
_DEFAULTS = {
    OP_VMAKE:  500,   # 5P   — 자막제거 1콜당. 사장님 확정 2026-08-22
              #        (고객은 5P 차감 / API 직접 등록 시 본인 키로 나가 차감 없음)
