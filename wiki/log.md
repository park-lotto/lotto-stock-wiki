- 2026-09-11 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-11.md
- 2026-09-09 — Excel ingest 완료:  → ingest_report_2026-09-09.md
- 2026-09-08 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-08.md
- 2026-09-07 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-07.md
- 2026-09-06 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-06.md
- 2026-09-05 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-05.md
- 2026-09-04 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-04.md
- 2026-09-03 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-03.md
- 2026-09-02 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-02.md
- 2026-09-01 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-09-01.md
- 2026-08-31 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-31.md
- 2026-08-30 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-30.md
- 2026-08-29 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-29.md
- 2026-08-28 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-28.md
- 2026-08-27 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-27.md
- 2026-08-26 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-26.md
- 2026-08-25 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-25.md
- 2026-08-24 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-24.md
- 2026-08-23 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-23.md
- 2026-08-22 — Excel ingest 완료:  → ingest_report_2026-08-22.md
- 2026-08-21 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-21.md
- 2026-08-20 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-20.md
- 2026-08-19 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-19.md
- 2026-08-18 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-18.md
- 2026-08-17 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-17.md
- 2026-08-16 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-16.md
- 2026-08-14 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-14.md
- 2026-08-13 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-13.md
- 2026-08-12 — Excel ingest 완료:  → ingest_report_2026-08-12.md
- 2026-08-11 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-11.md
- 2026-08-10 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-10.md
- 2026-08-09 — Excel ingest 완료:  → ingest_report_2026-08-09.md
- 2026-08-08 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-08.md
- 2026-08-07 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-07.md
- 2026-08-06 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-06.md
- 2026-08-05 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-05.md
- 2026-08-04 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-08-04.md
...
- 2026-07-28 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-28.md
- 2026-07-27 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-27.md
- 2026-07-26 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-26.md
- 2026-07-25 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-25.md
...
- 2026-07-15 (사무실PC) — [구현·푸시] **영상제작소 모션효과 파이프라인 Phase1 뼈대**(`shopping_shorts/`): 딸깍 넘는 최상효과 = Remotion으로 모션자산 프리렌더(전환·스티커)→ffmpeg overlay 합성(전체 Remotion렌더=자동화죽여 폐기). 전환도 xfade 아닌 **타임드 투명레이어 오버레이**(concat `-c copy` 유지=서버다운회피). SDD 8태스크(각 spec+quality 리뷰, 12유닛+e2e육안): motion_assets(매니페스트·레이어해석)·video_assemble `_motion_layer_filters`+`_burn_captions` 모션N개+색감필터 통합·mix_pipeline run_render 배선·motion_text 스텁·Remotion 프로젝트(`motion/`, ProRes4444→qtrle mov). **⚠️하드-원 교훈**: ①drawbox는 rgba알파 안박음→불투명도형을 투명캔버스에 overlay=format=auto 합성 ②VP9 webm은 ffmpeg 기본디코더가 알파무시→qtrle mov 사용 ③제품빌더 default overlay는 알파 정상존중. 육안검증: 파란베이스에 스와이프바+✨스파클 타이밍대로 투명합성+색감. memory `project_영상제작소_모션효과`·`reference_ffmpeg_alpha_overlay`. 다음=Phase2 팩(전환·타이포·콜아웃·색감 세트+per-video 텍스트렌더+위저드UI). 상세=NEXT_SESSION.md.
- 2026-07-15 (사무실PC) — [설계] **쇼핑쇼츠 장면 라이브러리 — AI 큐레이션 재사용 짤 뱅크**(`shopping_shorts/`): 믹스 첫단계에서 자주 쓰는 후킹 장면(놀라는짤·효과음·비법 한스푼 등)을 모아두고 AI가 대본 비트에 자동배치. 브레인스토밍(시각 companion 사용)→설계 완료. 핵심결정: ①3타입(화면짤clip/효과음sfx/오버레이overlay), 화면짤은 replace/cutaway 하이브리드 ②"한스푼" 애매함(가루↔세제) 해결 = 한단어라벨 금지, **다축 구조태그**(화면설명·역할·카테고리·소재·톤) Gemini 자동초안+사람확인 ③매칭=detect_subject+카테고리 1차필터→Gemini판정, 고신뢰 자동배치·저신뢰 제안만 ④접근1(자산=확장 화면인벤토리) 2페이즈(뱅크→매칭·렌더). 스펙 `docs/superpowers/specs/2026-07-15-쇼핑쇼츠-장면라이브러리-재사용짤뱅크-design.md`. ⚠️ 작업 중 내 spec 커밋(b60d43a1)이 동시세션 커밋들 사이로 dangling→워킹트리 파일 온전, 내 파일만 HEAD 위 재커밋으로 복구. 다음=사용자 spec 검토→writing-plans(페이즈1부터).
- 2026-07-15 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-15.md
...
- 2026-07-12 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-12.md
- 2026-07-11 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-11.md
- 2026-07-10 — [구현·배포] **쇼핑쇼츠 제품찾기: 임베드 검색 폐지 → 링크전용 UI 최종전환**(`shopping_shorts/`): "실수집"→"임베드 미리보기" 순으로 두 번 갈아엎은 뒤, 임베드 방식 자체가 실측(정확한 키워드로도 관련성 30~50%대, "리마커블 2" 검색 6개 중 2~3개만 관련) 결과 Apify 스크래퍼가 플랫폼 자체 검색 알고리즘을 복제 못 하는 구조적 한계로 결론 — 경쟁사(tubefactory)처럼 언어별 키워드 후보 전부를 그 플랫폼 자체 검색 링크로 만들어 클릭 이동시키는 방식으로 최종 전환. video_analysis.py에 Gemini response_schema 강제 추가(zh/ja/ru 키워드가 종종 빈 배열이던 버그 근본수정), search_links.py를 언어당 키워드 후보 전부 반환하도록 재설계, find.html을 왼쪽 원본영상+오른쪽 채널×키워드×언어 링크그리드(🔗/📋 아이콘)로 전면 재설계, 플랫폼별 기본언어를 콘텐츠 언어에 맞게 지정(중국어 플랫폼=중국어+영어)해 "중국어 플랫폼을 영어로 검색"하던 버그 해결. 임베드 관련 엔드포인트·테스트 전량 제거, 127 유닛테스트 통과+로컬서버 브라우저 라이브검증. 상세=NEXT_SESSION.md.
- 2026-07-10 — [버그수정] **쇼핑쇼츠: Gemini 키 로테이션 버그 + Apify 액터 스키마 변경 대응**(`shopping_shorts/`): ①새 Gemini 키 추가 후에도 계속 빈 결과 → 로그 추가해 진단해보니 429 쿼터소진이 아니라 401 UNAUTHENTICATED("바운드 서비스 계정 삭제/비활성화")였음, 기존 분류 로직 2개(`is_daily_exhausted_error`/`is_quota_error`) 둘 다 못 잡아서 죽은 키만 계속 재시도 중이었음 → `key_vault.is_account_disabled_error` 신설, 4개 모듈(video_analysis·comment_gen·similarity·product_identify) 전부 적용. 실영상으로 product_identify 검증 성공("reMarkable Paper Pro" 정확히 뽑힘). ②"apify 토큰 17개 전부 실패(400)" 재현 확인 중 액터(`apify~instagram-reel-scraper`) 빌드 타임스탬프가 당일 오전으로 확인 — 오늘 액터 자체가 업데이트되며 입력필드 `directUrls`를 완전히 없애고 `username` 하나로 통합했음(유저네임·프로필URL·릴스URL 전부 이 필드로). `fetch_single_reel()` 필드명 수정+실제 URL로 검증. 상세=NEXT_SESSION.md.
- 2026-07-10 — [구현·배포] **쇼핑쇼츠 5대플랫폼 완성+정확도개선+속도개선+제품정밀도**(`shopping_shorts/`): 전날 만든 "구매처 찾기"(SerpApi Lens 쇼핑몰검색)가 목적 오해(짜집기용 타영상 찾기가 진짜 목적)였음을 사용자가 정정 — 전체 제거. "정확도 떨어짐" 원인 발견: Gemini가 ko/en/zh 3개어 키워드 생성하는데 검색은 언어 하나만 써서 zh는 버려지고 있었음 → ko/en/zh/ja/ru 5개어 확장+전부검색+URL중복제거. 샤오홍슈(zen-studio~rednote-search-scraper)+도우인(zen-studio~douyin-search-scraper, 처음 조사한 액터는 0건이라 보류했다가 같은 개발자 다른액터로 재시도해 성공) 실수집 추가로 5대 플랫폼(유튜브/틱톡/인스타/샤오홍슈/도우인) 완성. 5개언어 순차검색+후보별 순차Gemini채점이 실측 27분+ 걸리던 것 발견 → ThreadPoolExecutor 병렬화로 3분47초로 단축(약7배, comment_gen.py에 RLock 추가). UI: 저정확도 수동링크 섹션 삭제+언어배지(🇰🇷🌐🇨🇳🇯🇵🇷🇺) 추가(source_lang 컬럼). "제품 직접홍보형" 영상 정밀도 개선용 product_identify.py 신설 — 6프레임 전부 구글렌즈 역검색 후 일관된 제품명을 Gemini가 확정해 키워드 맨앞에 추가(구매처찾기와 같은 Lens API를 용도만 바꿔 재활용). "레시피/생활용품형"(타입B)은 설계만 확인, 다음세션. 전부 커밋+배포(134 유닛테스트), 단 product_identify 실영상 검증은 Gemini 키 소진으로 이월. 상세=NEXT_SESSION.md.
- 2026-07-10 — Excel ingest 완료: 추정이익변경 → ingest_report_2026-07-10.md
- 2026-07-09 — [구현·배포] **쇼핑쇼츠 기능③ 소스매칭 실수집 완성 + 구매처 검색 신규**(DESKTOP, `shopping_shorts/` 별개프로젝트): 틱톡·인스타 실수집(Apify `clockworks~tiktok-scraper`, `apify~instagram-hashtag-scraper`) 구현·라이브 검증, 유사도 카드 시각화(초록테두리+✅뱃지). 버그 4건 수정: Gemini 모델명 오타(`gemini-3.5-flash`), 인스타 `resultsType` 기본값(posts)이라 사진만 나오던 문제(reels 명시+videoUrl필터), `/api/find/frame/*` 401이라 외부이미지검색 전부 막혀있던 문제(인증예외 추가), `PUBLIC_BASE_URL`이 내부루프백으로 잘못설정(실도메인 수정). **신규**: SerpApi Google Lens "🛍️ 구매처 찾기" — 프레임 이미지로 실제 판매처(Amazon/eBay 등) 역검색, 프레임마다 매칭편차 커서(배경소품 오매칭 실측) 자동전체수집 대신 프레임 수동선택 UI. 전부 커밋+push+서버배포+실API로 라이브검증(120 유닛테스트 통과). 미해결: 인스타 해시태그 정확일치라 복합키워드 0건 케이스(키워드 폴백 필요). 상세=NEXT_SESSION.md.
- 2026-07-08 — [버그수정·인프라] **서버 자동배포 크론 먹통 근본원인 해결 + 차트/투자자/뉴스 개선**(DESKTOP): 여러 세션에 걸쳐 이월되던 "서버 자동배포 크론 먹통"의 진짜 원인 발견 — 서버 로컬 git에 stray staged 대시보드 html + 서버 크롤봇이 직접 쓴 미커밋 raw/out/output 데이터 약 2,000개 파일(2026-07-05~08)이 쌓여 `git pull`이 2026-07-07 11:16부터 조용히 계속 실패 중이었음(대시보드 다크토글·순환매감지기 배포까지 막혔던 것). 서버 데이터 커밋+origin merge(add/add 충돌 760여건은 origin쪽 유지)+git bundle로 로컬 경유 push→서버 unstick, `/healthz` 정상 확인. 로컬 PC도 실시간 크롤봇 쓰기로 rebase가 막혀 격리된 `git worktree`로 우회하는 패턴 확립. 추가로 ①차트 그리기 도형 logical→time 앵커 전환(날짜밀림 드리프트 버그 fix, 레거시 자동마이그레이션) ②투자자 순매수 방향성 화살표+기관세부(금투/투신/사모/연기금 등) 추가 ③`_gemini_text` 타임아웃 없어 `_poll_briefing` 스레드 전체가 죽어 시장상황 타임라인이 매일 멈추던 버그 fix(45초 타임아웃) ④뉴스/시황 매크로 키워드 확장(ADR·상장·전쟁·연준 등)+순환매 카드 틱당1건 제한+뉴스 중요배지 기준 강화. 상세=NEXT_SESSION.md 최신세션.
- 2026-07-07 — [구현·배포] **순환매 감지기 신설**(커밋 69b83905): 어제 설계만 해둔 "섹터맵+게이트" 순환매 감지기를 구현. 트리거뉴스(atoms.db 강한원자 strength≥3 호재)+타섹터 급등(히트맵+5%↑, 트리거섹터 제외) **둘 다 있을 때만** Gemini가 인과관계 판단해 카드 생성 — 억지연결이면 빈결과 정상(strength_net '침묵금지'와 반대). 화살표맵(관계그래프) 불필요, 섹터버킷+LLM지식 온더플라이 매칭. `pipeline/atoms/circulation.py`(순수함수+13테스트), `server.py` `_circulation_tick`을 별도스레드 대신 `_poll_briefing` 15분게이트로 통합(weather state 레이스회피), `market.html` type:circulation 카드를 🔄로 시장상황 타임라인 노출. 1차 Gemini Flash(`_circ_gemini` 한함수만 바꾸면 Sonnet 교체). **미검증=실서버 라이브 판단품질**(다음세션 관측 후 Gemini→Sonnet 결정). 겸사겸사 시장상황 타임라인 테마당 3개제한 제거(8개까지 채우기, 커밋 39a807c7). 설계=`docs/superpowers/specs/2026-07-07-순환매감지기-design.md`.
- 2026-07-07 — [구현·배포] **대시보드 다크/화이트 테마 토글 + 인사이트 애플 리디자인 main 반영**(커밋 c4666fe7): ①7/5 완성한 애플 화이트 인사이트 리디자인이 `archive/briefing-engine`에만 있고 main엔 없어 라이브가 계속 옛 다크였음 → main으로 가져오며 `err()` 코드누출버그(retryFn.toString()→onclick 직접삽입) 수정. ②insights/market/net 3페이지 **공통 다크/화이트 토글**: :root토큰+prefers-color-scheme기본+data-theme override+localStorage 'sb-theme'공유, 우상단🌙/☀️, FOUC부트. insights 118색 토큰화(검은CTA→다크골드 반전토큰), market 크롬 회색램프 토큰화(셀은 채도유지), net GitHub라이트. 라이트/다크 헤드리스검증. ③어제 서버서만 만든 인사이트 결과물 tar-over-ssh로 로컬 회수(67→97). **⚠️ 서버 자동배포크론 먹통(서버 raw/ churn이 pull 충돌) → 3파일 타겟체크아웃 수동배포**. 미커밋 다수(내일).
...
## 2026-07-09 (밤) — SEO 구조분석→애드센스 사업 브레인스토밍 (별개 사업)
로또의 주식과 무관한 신규 사업 아이디어: 잘 만들어진 구글SEO 페이지 구조분석 → 애드센스 광고 수익 사업. 브레인스토밍만 진행, 6단계 로드맵 설계(구조분석→니치선정→파일럿구축→애드센스신청→검증→확장). 한국어 콘텐츠·AI자동생산(Gemini key_vault 재활용 검토)·워드프레스·파일럿1개사이트 확정. 니치는 미정 — 8개 후보 구조분석 먼저 하고 결정하기로 함. 설계 `docs/superpowers/specs/2026-07-09-SEO-애드센스-사업-design.md`. 다음: Phase1(니치8개 조사에이전트 병렬실행) 실행.
...
## 2026-07-15 (집PC) 영상제작소 대본·영상믹스 단계 통합 — SDD Task1~3(백엔드)
- 브레인스토밍→설계→계획→SDD. 제작소를 좌(영상풀)·우(결과) 2단으로 통합, 📝뽑기(대본)·🎬담기(화면) 겸용, 대본뽑기=도서관 생성모달 재사용(2경로 1엔진), ⭐위키저장 다리로 제작소서도 학습반영. 스펙·계획 `docs/superpowers/{specs,plans}/2026-07-15-쇼핑쇼츠-영상제작소-대본믹스-통합*`
- ✅ Task1(9e74e892+b0128340): 백엔드 `/api/produce/save_to_wiki`(URL기반·load_last_run 비의존·category 정규화). ✅ Task2(2e121144): produce.html 단계병합 골격(STEPS 8→7·data-step시프트·좌우2단·renderPool/toggleFootage·역할배정폐기·openScriptModal 스텁). ✅ Task3백엔드(bcd32029): generate 위키미저장 폴백(body structure/base_script). 각 spec+quality 리뷰 통과.
- ⏭ Task3 프론트(도서관모달 pm이식)부터 미완(세션한도). Task4 saveWikiBtn배선, Task5 grounding·배포. 상세 NEXT_SESSION 🎬섹션 / memory project_영상제작소_대본믹스통합
- ⚠️ 동시세션이 초단위로 같은 워킹트리 커밋 중 — Task2때 내 커밋 흡수(코드유실0). 학습배치 정상확인(크론 0 4·element_stats 81행)
- 2026-07-15(사무실) 보이스 **자연화 엔진(AI티 제거)** — 방향 대전환(규칙기반 서울20대여성톤, "1%도 AI면 실패"). 브레인스토밍→스펙(826a7451)→계획2부(4f53a9e1)→SDD 구현 7단위 완료: 엔진8스테이지 순수함수(narration_naturalize, 28테스트, opus리뷰로 실버그3수정)·tts(seed·연속성·v3 speaker_boost drop·N-best)·mix통합(_synthesize_beats)·asr_check(Whisper diff)·프리셋 profile저장+speaker_boost정리·voice-tune API4개·작업대 HTML(3546cd3f). ⏭집에서: whole-branch최종리뷰+ELEVENLABS키로 성우별 프로파일 귀튜닝(진짜게이트)+GROQ키 서버배포. 상세 NEXT_SESSION 🎙️섹션.
- 2026-07-15(집) 대본즐겨찾기 **소재고정** — 코드는 이미 구현·푸시·서버배포 완료였음(15bbfe99·30222f8f·cea4cb12·8b3bf859), NEXT_SESSION 미반영이라 미완으로 보였던 것. 라이브(shoppingshorts/library) 실검증: remake=소재 자동프리필("튀기지않은 건강한 감자튀김 만들기")+소재 유지한 채 표현만 리라이트 / transplant("무선 창문 청소기")=구조만 이식·원본소재 누출0. 프롬프트 튜닝 불필요 판정, NEXT_SESSION 🅐 ⏭#1 완료처리.
- 2026-07-15(집) 우리믹스 **썸네일 검은칸 근본해결** — 원인은 썸네일컬럼 부재가 아니라 `<video preload=metadata>` 대체+`/api/wiki/video` Range미적용(200/3.4MB 전체) → 10행=34MB 동시수신, readyState=0. 해결=`/api/wiki/poster`(보관mp4 0.1초 프레임 캐시, 55KB/824ms)+`<img>` 단일화. 부수확: `loading="lazy"`가 숨긴패널 innerHTML 렌더 탓에 뷰포트 안에서도 영영 미로드(eager로 확정) → 제거. 라이브 10/10 720x1280 육안확인. 커밋 d5f95a17·74bd8a24·9536605e(+13eaf79c에 store/app 흡수). 앞서 우리믹스·소재고정은 이미 구현완료 상태로 라이브검증만 함.
