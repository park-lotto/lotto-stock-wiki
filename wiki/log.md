- 2026-06-06 — 장전 브리핑 자동화 시스템 구축 | collect(wiki→Gemini이슈추출)+bot(텔레브리핑+자유판단)+card_gen(HTML카드)+publish(Playwright+채널전송)+run_briefing.bat | assistant_bot(/s /ask /brief /enhance /wiki, Gemini어시스턴트) | Task Scheduler 07:40 등록 완료
